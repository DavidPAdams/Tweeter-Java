...
import com.tts.tweeter.repository.TagRepository;
import com.tts.tweeter.repository.TweetRepository;
...
public class TweetService {
  ...
  private void handleTags(Tweet tweet) {
    ...
    while (matcher.find()) {
      ...
      Tag tag = tagRepository.findByPhraseContainsIgnoreCase(phrase);
      if (tag == null) {
        tag = new Tag();
